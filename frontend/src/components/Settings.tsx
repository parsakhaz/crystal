        ...
        {activeTab === 'stravu' && (
          <div className="space-y-6">
            ...
            >
              <div className="space-y-4">
                <p className="text-sm text-text-secondary leading-relaxed">
                  Stravu is the knowledge platform for AI-first teams. Connect foozol to your Stravu workspace to give Claude access to your team's documentation, best practices, and institutional knowledge.
                </p>
