        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-4 border-t border-border-primary">
            <p className="text-xs text-text-tertiary leading-relaxed">
              foozol is an independent project created by Stravu. Claude™ is a trademark of Anthropic, PBC.
              foozol is not affiliated with, endorsed by, or sponsored by Anthropic.
            </p>
          </div>
        </div>
      </div>
